...
public enum DatabaseOperation {
     ...
     * insert or replace existing data. Any database rows that are not in the
     * dataset remain unaffected.
     */
    REFRESH,
     ...
     * Identical to {@link #DELETE_ALL} expect this operation cannot be rolled back
     * and is supported by less database vendors.
     * 
     * @see #DELETE_ALL
     */
    TRUNCATE_TABLE,
