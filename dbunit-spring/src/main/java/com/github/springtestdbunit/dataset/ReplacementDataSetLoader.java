...
/**
 * A {@link DataSetLoader data set loader} that uses a
 * {@link ReplacementDataSet} to replace specific objects or sub-strings. By
 * default, will replace "[null]" with <code>null</code>.
 *
...
public class ReplacementDataSetLoader implements DataSetLoader {
     ...
     * {@link FlatXmlDataSetLoader} to load the source data and with
     * {@link #DEFAULT_OBJECT_REPLACEMENTS}.
     */
    ...
    /**
     * Create a new {@link ReplacementDataSetLoader} with
     * {@link #DEFAULT_OBJECT_REPLACEMENTS}.
     * 
     ...
     * 
     * @param dataSetLoader      the source data set loader
     * @param objectReplacements the object replacements or {@code null} if no
     ...
     * @param objectReplacements    the object replacements or {@code null} if no
     *                              object replacements are required
     * @param subStringReplacements the sub-string replacements or {@code null} if
