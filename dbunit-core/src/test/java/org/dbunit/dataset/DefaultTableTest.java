...
public class DefaultTableTest extends AbstractTableTest {
    ...
    protected ITable createTable(int columnCount, int rowCount, int startRow) throws Exception {
    ...
    public void testGetMissingValue() throws Exception {
        ...
        table.addRow(new Object[] { ITable.NO_VALUE, ITable.NO_VALUE, ITable.NO_VALUE, ITable.NO_VALUE, ITable.NO_VALUE,
                ITable.NO_VALUE });
