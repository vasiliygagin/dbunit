...
//            new Column("BAD_DELIMITED_SUBSTRING4", DataType.CHAR),
		...
		new Column("BAD_DELIMITED_SUBSTRING6", DataType.CHAR), new Column("BAD_SUBSTRING1", DataType.CHAR),
...
//            "${substringreplacement replacement",
	...
	Column[] columns = new Column[] { new Column("ONLY_SUBSTRING", DataType.CHAR),
		...
		new Column("BAD_DELIMITED_SUBSTRING2", DataType.CHAR),
//            new Column("BAD_DELIMITED_SUBSTRING4", DataType.CHAR),
		new Column("BAD_DELIMITED_SUBSTRING5", DataType.CHAR), new Column("BAD_SUBSTRING1", DataType.CHAR),
		new Column("BAD_SUBSTRING2", DataType.CHAR), };
