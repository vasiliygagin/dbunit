...
public class ColumnsTest extends TestCase {
	...
	Column[] expectedColumns = new Column[] { new Column("c0", DataType.UNKNOWN),
		new Column("c1", DataType.UNKNOWN), };
	Column[] actualColumns = new Column[] { new Column("c0", DataType.UNKNOWN),
		new Column("c1", DataType.UNKNOWN), };
	...
	Column[] expectedColumns = new Column[] { new Column("c0", DataType.UNKNOWN),
		new Column("c1", DataType.UNKNOWN), };
	// order [c1, c0]
	Column[] actualColumnsDifferentOrder = new Column[] { new Column("c1", DataType.UNKNOWN),
	...
	Column[] expectedColumns = new Column[] { new Column("c0", DataType.UNKNOWN),
		new Column("c2", DataType.UNKNOWN), new Column("c1", DataType.UNKNOWN), };
	Column[] actualColumns = new Column[] { new Column("d0", DataType.UNKNOWN),
		new Column("c2", DataType.UNKNOWN), };
	ITableMetaData metaDataExpected = createMetaData(expectedColumns);
	ITableMetaData metaDataActual = createMetaData(actualColumns);
