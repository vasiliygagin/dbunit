...
public class XmlDataSetWriterTest extends TestCase {
	...
	String col0 = "COL0";
	String col1 = "COL1";
	Column[] columns = new Column[] { new Column(col0, DataType.UNKNOWN), new Column(col1, DataType.UNKNOWN) };
	...
	// Setup
	Column[] columns = new Column[] { new Column("COL1", DataType.UNKNOWN) };
	...
	String expectedOutput = "<dataset>" + "<table name=\"TABLE1\">" + "<column>COL0</column>"
		+ "<column>COL1</column>" + "<row>" + "<value>t1v1</value>" + "<value>t1v2</value>" + "</row>"
		+ "</table>" + "</dataset>";
