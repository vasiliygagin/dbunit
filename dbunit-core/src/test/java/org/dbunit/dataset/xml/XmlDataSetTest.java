...
public class XmlDataSetTest extends AbstractDataSetTest {
    ...
    protected IDataSet createDuplicateDataSet() throws Exception {
        InputStream in = new FileInputStream(TestUtils.getFile("xml/xmlDataSetDuplicateTest.xml"));
        return new XmlDataSet(in);
    }
    ...
    /**
     * Overridden from parent because XmlDataSet has different behaviour than other
    ...
    public void testCreate_$InTableName_Success() throws DataSetException {
        ...
        assertEquals("Expected table name not found.", tableName, actualTableName);
    }
}
