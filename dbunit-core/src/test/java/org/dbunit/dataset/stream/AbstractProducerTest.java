...
public abstract class AbstractProducerTest extends TestCase {
    private static final String[] TABLE_NAMES = { "DUPLICATE_TABLE", "SECOND_TABLE", "TEST_TABLE", "NOT_NULL_TABLE",
            "EMPTY_TABLE", };
    ...
    public void testProduce() throws Exception {
        ...
        for (int i = 0; i < expectedNames.length; i++) {
            ...
            Column.Nullable nullable = expectedName.equals(getNotNullTableName()) ? Column.NO_NULLS : Column.NULLABLE;
