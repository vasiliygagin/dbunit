...
public class BigIntegerDataTypeTest extends AbstractDataTypeTest {
    private static final String NUMBER_LARGER_THAN_LONG = "17446744073709551630";
	...
	Object[] values = { null, "5", new Long(1234), new Float(Long.MAX_VALUE), new Float(Long.MIN_VALUE), "-7500",
		new Double(Long.MAX_VALUE), new Double(Long.MIN_VALUE), new Float(0.666), new Double(0.666),
		new Double(5.49), "-99.9", new Double(1.5E6), new BigDecimal((double) 1234), NUMBER_LARGER_THAN_LONG,
		new BigDecimal(NUMBER_LARGER_THAN_LONG), };

	BigInteger[] expected = { null, new BigInteger("5"), new BigInteger("1234"),
		new BigInteger("" + Long.MAX_VALUE), new BigInteger("" + Long.MIN_VALUE), new BigInteger("-7500"),
		new BigInteger("" + Long.MAX_VALUE), new BigInteger("" + Long.MIN_VALUE), new BigInteger("0"),
		new BigInteger("0"), new BigInteger("5"), new BigInteger("-99"), new BigInteger("1500000"),
		new BigInteger("1234"), new BigInteger(NUMBER_LARGER_THAN_LONG),
	...
	Object[] values1 = { null, "5", new Long(1234), new Float(Long.MAX_VALUE), new Float(Long.MIN_VALUE), "-7500",
		new Double(Long.MAX_VALUE), new Double(Long.MIN_VALUE), new Float(0.666), new Double(0.666),
		new Double(5.49), "-99.9", new Double(1.5E6), new BigDecimal((double) 1234), };

	Object[] values2 = { null, new Long(5), new Long(1234), new Long(Long.MAX_VALUE), new Long(Long.MIN_VALUE),
		new Long(-7500), new Long(Long.MAX_VALUE), new Long(Long.MIN_VALUE), new Long(0), new Long(0),
		new Long(5), new Long(-99), new Long(1500000), new Long(1234), };
