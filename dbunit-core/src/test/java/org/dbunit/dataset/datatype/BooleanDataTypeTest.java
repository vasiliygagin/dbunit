...
public class BooleanDataTypeTest extends AbstractDataTypeTest {
    ...
    public void testTypeCast() throws Exception {
        Object[] values = { null, "1", // Strings
                "0", "true", "false", "4894358", // TODO should it be possible to cast this into a Boolean?
                Boolean.TRUE, // Booleans
                Boolean.FALSE, new Integer(1), // Numbers
                new Integer(0), new Integer(123), // TODO should it be possible to cast this into a Boolean?
                new BigDecimal("20.53"), // TODO should it be possible to cast this into a Boolean?
        };
        Boolean[] expected = { null, Boolean.TRUE, // Strings
                Boolean.FALSE, Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, Boolean.TRUE, // Booleans
    ...
    public void testCompareEquals() throws Exception {
        Object[] values1 = { null, "1", "0", Boolean.TRUE, Boolean.FALSE, };
        Object[] values2 = { null, Boolean.TRUE, Boolean.FALSE, "true", "false", };
    ...
    public void testCompareInvalid() throws Exception {
        Object[] values1 = { "bla", Boolean.FALSE, };
        Object[] values2 = { Boolean.TRUE, "bla", };
    ...
    public void testCompareDifferent() throws Exception {
        Object[] less = { null, null, Boolean.FALSE, };
        Object[] greater = { Boolean.TRUE, Boolean.FALSE, Boolean.TRUE, };
    ...
    public void testGetSqlValue() throws Exception {
        Object[] expected = new Object[] { null, Boolean.TRUE, Boolean.FALSE, };
