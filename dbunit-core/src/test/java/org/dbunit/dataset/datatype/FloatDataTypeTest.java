...
public class FloatDataTypeTest extends AbstractDataTypeTest {
	...
	Object[] values = { null, "5.555", new Double(Float.MAX_VALUE), new Double(Float.MIN_VALUE), "-7500", "2.34E3",
		new Double(0.666), new Double(5.49879), "-99.9", new BigDecimal((double) 1234), };

	Float[] expected = { null, new Float(5.555), new Float(Float.MAX_VALUE), new Float(Float.MIN_VALUE),
		new Float(-7500), Float.valueOf("2.34E3"), new Float(0.666), new Float(5.49879), new Float(-99.9),
		new Float(1234), };
	...
	Object[] values1 = { null, "5.555", new Double(Float.MAX_VALUE), new Double(Float.MIN_VALUE), "-7500", "2.34E3",
		new Double(0.666), new Double(5.49879), "-99.9", new BigDecimal((double) 1234), };

	Float[] values2 = { null, new Float(5.555), new Float(Float.MAX_VALUE), new Float(Float.MIN_VALUE),
		new Float(-7500), Float.valueOf("2.34E3"), new Float(0.666), new Float(5.49879), new Float(-99.9),
		new Float(1234), };
	...
	Object[] values = { new Float("1234"), new Float("12.34"), };
