...
public class TimeDataTypeTest extends AbstractDataTypeTest {
	...
	Object[] values = { null, new Time(1234), new java.sql.Date(1234), new Timestamp(1234),
		new Time(1234).toString(), new java.util.Date(1234), };

	java.sql.Time[] expected = { null, new Time(1234), new Time(new java.sql.Date(1234).getTime()),
		new Time(new Timestamp(1234).getTime()), Time.valueOf(new Time(1234).toString()), new Time(1234), };
	...
	Object[] values1 = { null, new Time(1234), new java.sql.Date(1234), new Timestamp(1234),
		new Time(1234).toString(), new java.util.Date(1234), "00:01:02", };

	Object[] values2 = { null, new Time(1234), new Time(new java.sql.Date(1234).getTime()),
		new Time(new Timestamp(1234).getTime()), Time.valueOf(new Time(1234).toString()), new Time(1234),
		new Time(0, 1, 2), };
	...
	Object[] less = { null, new java.sql.Time(0), "08:00:00", "08:00:00", };

	Object[] greater = { new java.sql.Time(1234), new java.sql.Time(System.currentTimeMillis()), "20:00:00",
		"08:00:01", };
	...
	java.sql.Time[] values = { new java.sql.Time(1234), };

	String[] expected = { new java.sql.Time(1234).toString(), };
