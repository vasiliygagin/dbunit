...
public class DoubleDataTypeTest extends AbstractDataTypeTest {
    ...
    public void testTypeCast() throws Exception {
        Object[] values = { null, "5.555", new Float(Float.MAX_VALUE), new Double(Double.MIN_VALUE), "-7500", "2.34E23",
                new Double(0.666), new Double(5.49879), "-99.9", new BigDecimal((double) 1234), };

        Double[] expected = { null, new Double(5.555), new Double(Float.MAX_VALUE), new Double(Double.MIN_VALUE),
                new Double(-7500), Double.valueOf("2.34E23"), new Double(0.666), new Double(5.49879), new Double(-99.9),
                new Double(1234), };
    ...
    public void testCompareEquals() throws Exception {
        Object[] values1 = { null, "5.555", new Float(Float.MAX_VALUE), new Double(Double.MIN_VALUE), "-7500",
                "2.34E23", new Double(0.666), new Double(5.49879), "-99.9", new BigDecimal((double) 1234), "123", };

        Object[] values2 = { null, new Double(5.555), new Double(Float.MAX_VALUE), new Double(Double.MIN_VALUE),
                new Double(-7500), Double.valueOf("2.34E23"), new Double(0.666), new Double(5.49879), new Double(-99.9),
                new Double(1234), new Double(123.0) };
    ...
    public void testAsString() throws Exception {
        Object[] values = { new Double("1234"), new Double("12.34"), };

        String[] expected = { "1234.0", "12.34", };
