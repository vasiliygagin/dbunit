...
public class LongDataTypeTest extends AbstractDataTypeTest {
    ...
    public void testTypeCast() throws Exception {
        ...
        Long[] expected = { null, new Long(5), new Long(1234), new Long(Long.MAX_VALUE), new Long(Long.MIN_VALUE),
    ...
    public void testSqlType() throws Exception {
        // This test was commented out in release 2.4.6 because the LongDataType is not
        // used anymore
        // by default for the SQL type BIGINT. This is due to a bug with values that
        // have more than 19 digits
