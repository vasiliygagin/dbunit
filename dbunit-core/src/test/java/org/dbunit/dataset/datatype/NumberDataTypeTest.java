...
public class NumberDataTypeTest extends AbstractDataTypeTest {
	...
	Object[] values = { null, new BigDecimal((double) 1234), "1234", "12.34", Boolean.TRUE, Boolean.FALSE,
		new Double(2.1), new Float(3.1F), new Integer(4), new Long(5), new Short((short) 6),
		new BigInteger("12345") };
	BigDecimal[] expected = { null, new BigDecimal((double) 1234), new BigDecimal((double) 1234),
		new BigDecimal("12.34"), new BigDecimal("1"), new BigDecimal("0"), new BigDecimal("2.1"),
		new BigDecimal("3.1"), new BigDecimal("4"), new BigDecimal("5"), new BigDecimal("6"),
	...
	Object[] values1 = { null, new BigDecimal((double) 1234), "1234", "12.34", Boolean.TRUE, Boolean.FALSE,
		new BigDecimal(123.4), "123", };
	Object[] values2 = { null, new BigDecimal((double) 1234), new BigDecimal(1234), new BigDecimal("12.34"),
		new BigDecimal("1"), new BigDecimal("0"), new BigDecimal(123.4000), new BigDecimal("123.0"), };
	...
	Object[] less = { null, "-7500", new BigDecimal("-0.01"), new BigInteger("1234"), };

	Object[] greater = { "0", "5.555", new BigDecimal("0.01"), new BigDecimal("1234.5"), };
	...
	BigDecimal[] expected = { null, new BigDecimal("12.34"), };
