...
public class DateDataTypeTest extends AbstractDataTypeTest {
    ...
    public void testTypeCast() throws Exception {
        Object[] values = { null, new java.sql.Date(1234), new Time(1234), new Timestamp(1234),
                new java.sql.Date(1234).toString(), new Timestamp(1234).toString(), new java.util.Date(1234), };

        java.sql.Date[] expected = { null, new java.sql.Date(1234), new java.sql.Date(new Time(1234).getTime()),
                new java.sql.Date(new Timestamp(1234).getTime()),
                java.sql.Date.valueOf(new java.sql.Date(1234).toString()),
                new java.sql.Date(Timestamp.valueOf(new Timestamp(1234).toString()).getTime()),
    ...
    public void testTypeCastInvalid() throws Exception {
        Object[] values = { new Integer(1234), new Object(), "bla", "2000.05.05", };
    ...
    public void testTypeCastRelative() throws Exception {
        ...
        for (int i = 0; i < values.length; i++) {
            assertEquals("typecast " + i, expected[i], thisType.typeCast(values[i]));
        }
    }

    public void testCompareEquals() throws Exception {
        Object[] values1 = { null, new java.sql.Date(1234), new Time(1234), new Timestamp(1234),
                new java.sql.Date(1234).toString(), new java.util.Date(1234), "2003-01-30" };

        Object[] values2 = { null, new java.sql.Date(1234), new java.sql.Date(new Time(1234).getTime()),
                new java.sql.Date(new Timestamp(1234).getTime()),
                java.sql.Date.valueOf(new java.sql.Date(1234).toString()), new java.sql.Date(1234),
    ...
    public void testCompareInvalid() throws Exception {
        Object[] values1 = { new Integer(1234), new Object(), "bla", "2000.05.05", };
        Object[] values2 = { null, null, null, null, };
    ...
    public void testCompareDifferent() throws Exception {
        Object[] less = { null, new java.sql.Date(0), "1974-06-23" };

        Object[] greater = { new java.sql.Date(1234), new java.sql.Date(System.currentTimeMillis()),
                java.sql.Date.valueOf("2003-01-30"), };
    ...
    public void testAsString() throws Exception {
        java.sql.Date[] values = { new java.sql.Date(1234), };

        String[] expected = { new java.sql.Date(1234).toString(), };
    ...
    public void testGetSqlValue() throws Exception {
        java.sql.Date[] expected = { null, new java.sql.Date(1234), };
