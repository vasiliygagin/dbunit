...
public class IsActualNotEqualToExpectedValueComparerTest {
    private final IsActualNotEqualToExpectedValueComparer sut = new IsActualNotEqualToExpectedValueComparer();
    ...
    @Test
    public void testIsExpected_NotEqualNumbers_True() throws DatabaseUnitException {
        final ITable expectedTable = null;
        final ITable actualTable = null;
        final int rowNum = 0;
        final String columnName = null;
