...
public class IsActualNotNullValueComparerTest {
    private IsActualNotNullValueComparer sut = new IsActualNotNullValueComparer();
	...
	final boolean actual = sut.isExpected(expectedTable, actualTable, rowNum, columnName, dataType, expectedValue,
		actualValue);
	assertThat("Actual null should have been false.", actual, equalTo(false));
    }
	...
	final boolean actual = sut.isExpected(expectedTable, actualTable, rowNum, columnName, dataType, expectedValue,
		actualValue);
	assertThat("Actual not null should have been true.", actual, equalTo(true));
    }
