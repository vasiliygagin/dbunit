...
public class IsActualGreaterThanExpectedValueComparerTest {
    private final IsActualGreaterThanExpectedValueComparer sut = new IsActualGreaterThanExpectedValueComparer();
    ...
    @Test
    public void testIsExpected_ActualEqualToExpected_False() throws DatabaseUnitException {
	final ITable expectedTable = null;
	final ITable actualTable = null;
	final int rowNum = 0;
	final String columnName = null;
