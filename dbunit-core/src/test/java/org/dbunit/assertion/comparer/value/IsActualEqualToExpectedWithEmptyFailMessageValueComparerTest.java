...
public class IsActualEqualToExpectedWithEmptyFailMessageValueComparerTest {
    private final IsActualEqualToExpectedWithEmptyFailMessageValueComparer sut = new IsActualEqualToExpectedWithEmptyFailMessageValueComparer();
    ...
    @Test
    public void testIsExpected_ActualEqualToExpected_True() throws DatabaseUnitException {
        final ITable expectedTable = null;
        final ITable actualTable = null;
        final int rowNum = 0;
        final String columnName = null;
    ...
    @Test
    public void testIsExpected_ActualGreaterThanExpected_False() throws DatabaseUnitException {
        final ITable expectedTable = null;
        final ITable actualTable = null;
        final int rowNum = 0;
        final String columnName = null;
        ...
        final boolean actual = sut.isExpected(expectedTable, actualTable, rowNum, columnName, dataType, expectedValue,
                actualValue);
        assertThat("Actual is greater than expected, should not have been true.", actual, equalTo(false));
    }

    @Test
    public void testIsExpected_ActualLessThanExpected_False() throws DatabaseUnitException {
        final ITable expectedTable = null;
        final ITable actualTable = null;
        final int rowNum = 0;
        final String columnName = null;
    ...
    public void testGetFailPhrase() {
        ...
        assertThat("Fail phrase is not null" + " and must be null for backwards compatability.", actual, nullValue());
    }
    ...
    public void testMakeFailMessage() throws Exception {
        ...
        assertThat("Fail phrase is not empty String" + " and must be empty for backwards compatability.", actual,
                equalTo(""));
    }
}
