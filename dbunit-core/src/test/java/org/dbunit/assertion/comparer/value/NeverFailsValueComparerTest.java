...
public class NeverFailsValueComparerTest {
    ...
    @Test
    public void testIsExpected_DifferenceValues_True() throws DatabaseUnitException {
        final ITable expectedTable = null;
        final ITable actualTable = null;
        final int rowNum = 0;
        final String columnName = null;
    ...
    public void testGetFailPhrase() {
        ...
        assertThat("Fail phrase is not empty String" + " and must be empty for never fails.", actual, equalTo(""));
    }
}
