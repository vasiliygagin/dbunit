...
public class IsActualGreaterThanOrEqualToExpectedValueComparerTest {
    private final IsActualGreaterThanOrEqualToExpectedValueComparer sut = new IsActualGreaterThanOrEqualToExpectedValueComparer();
    ...
    @Test
    public void testIsExpected_ActualGreaterThanExpected_True() throws DatabaseUnitException {
        final ITable expectedTable = null;
        final ITable actualTable = null;
        final int rowNum = 0;
        final String columnName = null;
