...
public class IsActualWithinToleranceOfExpectedTimestampValueComparerTest {
    ...
    public void testIsExpected_AllNull_True() throws DatabaseUnitException {
        ...
        final IsActualWithinToleranceOfExpectedTimestampValueComparer sut = new IsActualWithinToleranceOfExpectedTimestampValueComparer(
    ...
    @Test
    public void testIsExpected_WithinToleranceMiddle_True() throws DatabaseUnitException {
    ...
    @Test
    public void testIsExpected_WithinToleranceMatchLow_True() throws DatabaseUnitException {
        final long lowToleranceValueInMillis = 500;
        final long highToleranceValueInMillis = 1500;
        final IsActualWithinToleranceOfExpectedTimestampValueComparer sut = new IsActualWithinToleranceOfExpectedTimestampValueComparer(
                lowToleranceValueInMillis, highToleranceValueInMillis);
        ...
        assertThat("Test setup problem, diff does not match low tolerance", diff, equalTo(lowToleranceValueInMillis));
    ...
    @Test
    public void testIsExpected_WithinToleranceMatchHigh_True() throws DatabaseUnitException {
        final long lowToleranceValueInMillis = 500;
        final long highToleranceValueInMillis = 1500;
        final IsActualWithinToleranceOfExpectedTimestampValueComparer sut = new IsActualWithinToleranceOfExpectedTimestampValueComparer(
                lowToleranceValueInMillis, highToleranceValueInMillis);
        ...
        final long diff = Math.abs(expectedMillis - actualMillis);
        assertThat("Test setup problem, diff does not match high tolerance", diff, equalTo(highToleranceValueInMillis));
    ...
    public void testIsTolerant_DiffTimeNotInRangeLow_False() {
        ...
        assertThat("Diff value is low of tolerant range but passed.", actual, equalTo(false));
    }
    ...
    public void testIsTolerant_DiffTimeNotInRangeHigh_False() {
        ...
        assertThat("Diff value is high of tolerant range but passed.", actual, equalTo(false));
    }
    ...
    public void testIsTolerant_DiffTimeInRange_True() {
        ...
        final long diffTime = lowToleranceValueInMillis + highToleranceValueInMillis / 2;
        final boolean actual = sut.isTolerant(diffTime);

        assertThat("Diff value is in tolerant range but did not pass.", actual, equalTo(true));
    }
