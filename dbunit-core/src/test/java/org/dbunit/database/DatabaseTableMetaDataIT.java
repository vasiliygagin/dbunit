...
//        String[] expected = {"PK0"};
    ...
    public void testGetNoColumns() throws Exception {
        ...
        ITableMetaData metaData = new DatabaseTableMetaData(tableName, getConnection(), validate);
    ...
    public void testColumnDataType() throws Exception {
        ...
        for (int i = 0; i < expectedNames.size(); i++) {
            ...
            if (expectedTypes.get(i).equals(DataType.NUMERIC)) {
                // 2009-10-10 TODO John Hurst: hack for Oracle, returns java.sql.Types.DECIMAL
                // for this column
                assertTrue("Expected numeric datatype, got [" + column.getDataType() + "]",
                        column.getDataType().equals(DataType.NUMERIC) || column.getDataType().equals(DataType.DECIMAL));
                ...
                // 2009-10-22 TODO John Hurst: hack for Postgresql, returns VARCHAR for
                // VARBINARY.
                // Need to move DataType comparison to DatabaseEnvironment.
                assertTrue(true);
            } else {
    ...
    public void testCaseInsensitiveAndI18n() throws Exception {
        ...
        // Set the locale to turkish where "i".toUpperCase() produces an "\u0131" ("I"
        // with dot above) which is not equal to "I".
        ...
        try {
            ...
            // Is it because "internal toUpperCase() mentioned above is actually not being
            // called?
            // Investigate further.
//            String tableName = "empty_multitype_table";
            String tableName = "EMPTY_MULTITYPE_TABLE";
