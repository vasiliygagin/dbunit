...
public class BiDirectionalEdgesDepthFirstSearchTest extends DepthFirstSearchTest {
     ...
     * String[] { A, B, B, A, B }); addEdges(A, new String[] { B }); setOutput(new
     * String[] { B, A }); doIt(); }
     * 
     * public void testDisconnected() throws Exception { setInput(new String[] { A,
     * C }); addEdges(A, new String[] { B }); setOutput(new String[] { B, A, C });
     * doIt(); }
     * 
     * public void testDisconnectedInverseOrder() throws Exception { setInput(new
     * String[] { C, A }); addEdges(A, new String[] { B }); setOutput(new String[] {
     * B, A, C }); doIt(); }
     * 
     * public void testMultipleEdgesOneSource() throws Exception { setInput(new
     * String[] { A }); addEdges(A, new String[] { B, C }); setOutput(new String[] {
     * B, C, A }); doIt(); }
     * 
     * public void testMultipleEdgesMultipleSources() throws Exception {
     * setInput(new String[] { A }); addEdges(A, new String[] { B, C }); addEdges(B,
     * new String[] { D, C }); setOutput(new String[] { C, D, B, A }); doIt(); }
     */
     ...
     * addEdges(A, new String[] { A }); setOutput(new String[] { A }); doIt(); }
     * 
     */
