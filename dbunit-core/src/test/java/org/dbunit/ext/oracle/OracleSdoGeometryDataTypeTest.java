...
public class OracleSdoGeometryDataTypeTest extends AbstractDataTypeTest {
    ...
    public void testTypeCast() throws Exception {
        Object[] values = { null, new OracleSdoGeometry(null, null, null, null, null),
                ...
                new OracleSdoGeometry(null, null,
                        new OracleSdoPointType(new BigDecimal(1), new BigDecimal(2), new BigDecimal(3)), null, null),
                ...
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"),
                        new OracleSdoPointType(new BigDecimal("-1234.564"), new BigDecimal("5.3403"),
                                new BigDecimal(57)),
                        new OracleSdoElemInfoArray(new BigDecimal[] { new BigDecimal(10), new BigDecimal(9),
                                new BigDecimal(8), new BigDecimal(7) }),
                        new OracleSdoOrdinateArray(new BigDecimal[] { new BigDecimal(6), new BigDecimal(5),
                                new BigDecimal(4), new BigDecimal(3) })),
                "NULL", " NULL ", "sdo_geometry(123, null, null, null, null)",
                "sdo_gEOMEtry(123, null, null, null, null)", "mdsys.sdo_geometry(123, 45.6, null, null, null)",
        ...
        OracleSdoGeometry[] expected = { null, new OracleSdoGeometry(null, null, null, null, null),
                new OracleSdoGeometry(new BigDecimal(123), null, null, null, null),
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"), null, null, null),
                new OracleSdoGeometry(null, null, new OracleSdoPointType(null, null, null), null, null),
                new OracleSdoGeometry(null, null,
                ...
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"),
                        ...
                        new OracleSdoOrdinateArray(new BigDecimal[] { new BigDecimal(6), new BigDecimal(5),
                                new BigDecimal(4), new BigDecimal(3) })),
                null, null, new OracleSdoGeometry(new BigDecimal(123), null, null, null, null),
                new OracleSdoGeometry(new BigDecimal(123), null, null, null, null),
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"), null, null, null),
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"), new OracleSdoPointType(), null,
                        null),
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"),
                        new OracleSdoPointType(new BigDecimal("987.34"), new BigDecimal("56.3"),
                ...
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"),
                        ...
                        new OracleSdoElemInfoArray(new BigDecimal[] { new BigDecimal(1), null, new BigDecimal(2), null,
                                new BigDecimal(3), null }),
                        null),
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"),
                        new OracleSdoPointType(new BigDecimal("987.34"), new BigDecimal("56.3"), new BigDecimal("3")),
                        new OracleSdoElemInfoArray(new BigDecimal[] { new BigDecimal(1), new BigDecimal(2) }),
                        new OracleSdoOrdinateArray()),
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"),
                        new OracleSdoPointType(new BigDecimal("987.34"), new BigDecimal("56.3"), new BigDecimal("3")),
                        new OracleSdoElemInfoArray(new BigDecimal[] { new BigDecimal(1), new BigDecimal(3) }),
                        new OracleSdoOrdinateArray(new BigDecimal[] { null })),
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"),
                        new OracleSdoPointType(null, null, null),
                        new OracleSdoElemInfoArray(new BigDecimal[] { new BigDecimal(1), new BigDecimal(4) }),
                        new OracleSdoOrdinateArray(
                                new BigDecimal[] { new BigDecimal(4), new BigDecimal(5), null, new BigDecimal(6) })), };
    ...
    public void testCompareEquals() throws Exception {
        ...
        Object[] values2 = { null, new OracleSdoGeometry(null, null, null, null, null),
                new OracleSdoGeometry(new BigDecimal(123), null, null, null, null),
                new OracleSdoGeometry(new BigDecimal(123), new BigDecimal("45.6"), null, null, null),
                new OracleSdoGeometry(null, null, new OracleSdoPointType(null, null, null), null, null),
                new OracleSdoGeometry(null, null,
    ...
    public void testCompareDifferent() throws Exception {
        ...
        Object[] greater = { new OracleSdoGeometry(new BigDecimal(1), new BigDecimal(2), null, null, null), };
