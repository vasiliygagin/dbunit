...
/**
 * This class is a wrapper for another table with the condition that only a
 * subset of the original table will be available - the subset is defined by the
 * set of primary keys that are allowed in the new table.
 * 
...
public class PrimaryKeyFilteredTableWrapper implements ITable {
    ...
    /**
     * Creates a PKFilteredTable given an original table and the allowed primary
     * keys for that table.
     * 
