...
public class QueryDataSet extends AbstractDataSet {
     ...
     * @param query     The query to retrieve data with for this table. Can be null
     *                  which will select all data (see {@link #addTable(String)}
     *                  for details)
    ...
    /**
     * Represents a table and a SQL query that should be used to retrieve the data
     * for this table.
     */
