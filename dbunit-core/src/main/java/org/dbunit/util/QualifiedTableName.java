...
public class QualifiedTableName {
     ...
     *                      <code>defaultSchema</code> parameter.
    ...
    /**
     * @return The schema name which can be null if no schema has been given in the
     *         constructor
     */
    ...
    /**
     * Returns the qualified name using the values given in the constructor. The
     * qualified table name is <b>only</b> returned if the feature
