...
public class Base64 {
    ...
    /**
     * Decodes data from Base64 notation and returns it as a string. Equivalent to
    ...
    public static class OutputStream extends java.io.FilterOutputStream {
        ...
        /**
         * Appropriately pads Base64 notation when encoding or throws an exception if
         * Base64 input is not properly padded when decoding.
         *
         * @since 1.3
         */
