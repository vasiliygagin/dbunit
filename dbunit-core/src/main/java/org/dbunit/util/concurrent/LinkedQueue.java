...
public class LinkedQueue implements Channel {
    ...
    /**
     * The number of threads waiting for a take. Notifications are provided in put
     * only if greater than zero. The bookkeeping is worth it here since in
     * reasonably balanced usages, the notifications will hardly ever be necessary,
     * so the call overhead to notify can be eliminated.
     **/
