...
public class PropertyChangeMulticaster implements Serializable {
    ...
    /**
     * HashMap for managing listeners for specific properties. Maps property names
     * to PropertyChangeMulticaster objects.
     * 
     * @serial
     */
     ...
     * for all properties. If the listener is added multiple times, it will receive
     * multiple change notifications upon any firePropertyChange
     *
     ...
     * maintains Set semantics: If the listener is already registered, the operation
     * has no effect.
     *
     * @param listener The PropertyChangeListener to be added
     * @exception NullPointerException If listener is null
    ...
    /**
     * Remove a PropertyChangeListener from the listener list. It removes at most
     * one occurrence of the given listener. If the listener was added multiple
     * times it must be removed mulitple times. This removes a
     ...
     * However, if a listener is registered both for all properties and a specific
     * property, it will receive multiple notifications upon changes to that
     * property.
     *
    ...
    /**
     * Add a PropertyChangeListener for a specific property, if it is not already
     * registered. The listener will be invoked only when a call on
     ...
     * given property. If the listener is also registered for all properties, then
     * it will continue to be registered for them.
     *
    ...
    /**
     * Check if there are any listeners for a specific property. If propertyName is
     * null, return whether there are any listeners at all.
     *
