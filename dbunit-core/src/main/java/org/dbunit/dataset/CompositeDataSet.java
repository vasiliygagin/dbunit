...
public class CompositeDataSet extends AbstractDataSet {
    ...
    /**
     * Creates a composite dataset that combines specified datasets. Tables having
     ...
     * @param combine  if <code>true</code>, tables having the same name are merged
     *                 into one table.
     */
     ...
     *
     * @param dataSets                list of datasets
     * @param combine                 if <code>true</code>, tables having the same
     *                                name are merged into one table.
     * @param caseSensitiveTableNames Whether or not table names are handled in a
     *                                case sensitive way over all datasets.
     * @since 2.4.2
     */
    ...
    /**
     * Creates a composite dataset that combines the two specified datasets. Tables
    ...
    /**
     * Creates a composite dataset that combines duplicate tables of the specified
     * dataset.
     *
     ...
     *             <code>false</code>. Use overload that doesn't have the combine
     *             argument.
     */
     ...
     * @param tableMap
     * @param combine
     * @throws AmbiguousTableNameException Can only occur when the combine flag is
