 ...
 * tables in a dataset. This implementation does not support duplicate table
 * names. Thus you cannot specify the same table name more than once in this
 * filter and the filtered dataset must not contains duplicate table names. This
 * is the default filter used by the {@link org.dbunit.dataset.FilteredDataSet}.
 *
