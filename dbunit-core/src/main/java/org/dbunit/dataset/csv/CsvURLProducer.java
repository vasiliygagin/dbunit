...
/**
 * A {@link IDataSetProducer Data Set Producer} that produces datasets from CVS
 * files found at a base URL.
 * 
...
public class CsvURLProducer implements IDataSetProducer {
    ...
    /**
     * the consumer of the produced datasets, by default a {@link DefaultConsumer}
     */
    ...
    /**
     * Create a CSV Data Set Producer which uses the base URL to retrieve a list of
     * tables and the data.
     * 
    ...
    /**
     * Produce a dataset from a URL. The URL is assumed to contain data in CSV
     * format.
     * 
