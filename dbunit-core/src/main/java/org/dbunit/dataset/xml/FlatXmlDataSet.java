...
public class FlatXmlDataSet extends CachedDataSet {
    ...
    /**
     * Creates an FlatXmlDataSet object with the specified xml file. Relative
     * DOCTYPE uri are resolved from the xml file path.
     *
     ...
     * @param xmlFile       the xml file
     * @param dtdMetadata   if <code>false</code> do not use DTD as metadata
     * @param columnSensing Whether or not the columns should be sensed
     *                      automatically. Every XML row is scanned for columns that
     *                      have not been there in a previous column.
     * @deprecated since 2.4.7 - use {@link FlatXmlDataSetBuilder} to create a
     *             {@link FlatXmlDataSet}
     */
     ...
     *
     * @param xmlFile                 the xml file
     * @param dtdMetadata             if <code>false</code> do not use DTD as
     *                                metadata
     * @param columnSensing           Whether or not the columns should be sensed
     *                                automatically. Every XML row is scanned for
     *                                columns that have not been there in a previous
     *                                column.
    ...
    /**
     * Creates an FlatXmlDataSet object with the specified xml URL. Relative DOCTYPE
     * uri are resolved from the xml file path.
     *
    ...
    /**
     * Creates an FlatXmlDataSet object with the specified xml reader. Relative
     * DOCTYPE uri are resolved from the current working directory.
     *
