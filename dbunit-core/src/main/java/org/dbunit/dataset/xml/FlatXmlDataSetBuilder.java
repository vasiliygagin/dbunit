...
public final class FlatXmlDataSetBuilder {
    ...
    /**
     * The metadata (column information etc.) for the flat XML to be built. If this
     * is set the builder properties
     * <ul>
    ...
    /**
     * Whether or not DTD metadata is available to parse via a DTD handler. Defaults
     * to {@value}
     */
...
//TODO Think about this: should we use "columnSensing=true" by default if no DTD is specified? To avoid e.g. bug reports like #2812985 https://sourceforge.net/tracker/?func=detail&atid=449491&aid=2812985&group_id=47439
    ...
    /**
     * Sets the flat XML input source from which the {@link FlatXmlDataSet} is to be
     * built
     * 
    ...
    /**
     * Set the metadata information (column info etc.) to be used. May come from a
     * DTD. This has precedence to the other builder's properties.
     * 
     * @param metaDataSet
     * @return this
     */
    ...
    /**
     * Set the metadata information (column info etc.) to be used from the given DTD
     * input. This has precedence to the other builder's properties.
     * 
    ...
    /**
     * Builds the {@link FlatXmlDataSet} from the parameters that are currently set
     * on this builder
     * 
     * @param inputSource The XML input to be built
     * @return The {@link FlatXmlDataSet} built from the configuration of this
     *         builder.
     * @throws DataSetException
     */
