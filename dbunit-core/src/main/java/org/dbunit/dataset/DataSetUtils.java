...
public class DataSetUtils {
     ...
     * table names, the columns order, the columns data type and the primary keys.
     *
     * @deprecated Use Assertion.assertEquals
     */
    @Deprecated
    ...
    /**
     * Returns the specified name qualified with the specified prefix. The name is
     * not modified if the prefix is <code>null</code> or if the name is already
     * qualified.
     * <p>
     * Example: <br>
     * <code>getQualifiedName(null, "NAME")</code> returns <code>"NAME"</code>.
     * <code>getQualifiedName("PREFIX", "NAME")</code> returns
     * <code>"PREFIX.NAME"</code> and
     * <code>getQualifiedName("PREFIX2", "PREFIX1.NAME")</code> returns
     * <code>"PREFIX1.NAME"</code>.
     *
     * @param prefix the prefix that qualifies the name and is prepended if the name
     *               is not qualified yet
     ...
     * @param name          the name The name to be qualified if it is not qualified
     *                      already
     * @param escapePattern The escape pattern to be applied on the prefix and the
     *                      name. Can be null.
     * @return The qualified name
     * @deprecated since 2.3.0. Prefer usage of
     *             {@link QualifiedTableName#getQualifiedName()} creating a new
    ...
    /**
     * Returns the specified value as a string to be use in an SQL Statement. For
     * example the string <code>myValue</code> is returned as
     * <code>'myValue'</code>.
     *
     ...
     * @param columns    the array of columns from which the column must be
     *                   searched.
