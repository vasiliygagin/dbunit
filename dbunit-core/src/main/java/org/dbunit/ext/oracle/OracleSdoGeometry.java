...
public class OracleSdoGeometry implements ORAData, ORADataFactory {
    ...
    public OracleSdoGeometry(java.math.BigDecimal sdoGtype, java.math.BigDecimal sdoSrid, OracleSdoPointType sdoPoint,
            OracleSdoElemInfoArray sdoElemInfo, OracleSdoOrdinateArray sdoOrdinates) throws SQLException {
        _init_struct(true);
    ...
    public String toString() {
        try {
            return "MDSYS.SDO_GEOMETRY" + "(" + getSdoGtype() + "," + getSdoSrid() + "," + getSdoPoint() + ","
                    + getSdoElemInfo() + "," + getSdoOrdinates() + ")";
        } catch (Exception e) {
            return e.toString();
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        try {
            return OracleSdoHelper.objectsEqual(getSdoGtype(), otherSdoGeom.getSdoGtype())
