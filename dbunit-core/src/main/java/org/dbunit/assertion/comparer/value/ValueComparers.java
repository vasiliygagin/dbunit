...
public abstract class ValueComparers {
    ...
    /**
     * Same as {@link #isActualEqualToExpected} but its {@link ValueComparer} fail
     * message is an empty String (the {@link org.dbunit.assertion.Difference} fail
     * message still exists). Use this one mainly for backwards compatibility so the
