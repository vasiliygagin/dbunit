...
public interface PrepAndExpectedTestCase {
     ...
     *
     * @param verifyTableDefinitions Table definitions to verify after test
     *                               execution.
     * @param prepDataFiles          The prep data files (as classpath resources) to
     *                               load and insert contents into the database as
     *                               seed data.
     * @param expectedDataFiles      The expected data files (as classpath
     *                               resources) to load as expected data and verify
     *                               actual data matches at test end.
     * @throws Exception
     */
    ...
    /**
     * For the provided VerifyTableDefinitions, verify each table's actual results
     * are as expected.
     *
     * @throws Exception
     */
    ...
    /**
     * Cleanup tables specified in prep and expected datasets, using the provided
     * databaseTester. See {@link org.dbunit.IDatabaseTester#onTearDown()}.
     *
     * @throws Exception
     */
