...
public class DefaultExpectedDataSetAndVerifyTableDefinitionVerifier
    ...
    public void verify(final VerifyTableDefinition[] verifyTableDefinitions, final IDataSet expectedDataSet,
        ...
        log.debug("{}: expectedTables count={}, verifyTableDefinitions count={}", methodName, expectedTablesCount,
                verifyTableDefsCount);
    ...
    protected void handleCountMismatch(final VerifyTableDefinition[] verifyTableDefinitions,
        ...
        final String msg = "{}: Test specified {} expected tables" + " and {} VerifyTableDefinitions;"
        ...
        final Set<String> mismatchedTableNames = makeMismatchedTableNamesList(verifyTableDefinitions,
                expectedTableNames);
    ...
    protected Set<String> makeMismatchedTableNamesList(final VerifyTableDefinition[] verifyTableDefinitions,
        ...
        for (int i = 0; i < expectedTablesCount; i++) {
            ...
            final boolean isExpectedTableExist = isVerifyTableDefinitionsHasTable(verifyTableDefinitions,
                    expectedTableName);
    ...
    protected boolean isVerifyTableDefinitionsHasTable(final VerifyTableDefinition[] verifyTableDefinitions,
    ...
    protected void failOnMismatch(final DatabaseConfig config, final Set<String> mismatchCountTables)
